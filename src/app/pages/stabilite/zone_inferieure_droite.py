"""
Page de stabilite: zone inferieure droite (tau > 0, 0 < delta < tau^2/4)
...
log.info("Enregistrement de la page /stabilite/zone-inferieure-droite.")

dash.register_page(
    __name__,
    path="/stabilite/zone-inferieure-droite",
    name="Stabilite (inf. droite)",
    title="Stabilite – Zone inferieure droite",
    order=13,
    description="Informations sur la zone inferieure droite du diagramme de Poincare.",
)

log.debug("Construction du layout de la page zone inferieure droite...")
    ...
    [
        html.Small(
            [
                ...
                "  /  ",
                html.Span("Zone inferieure droite"),
            ],
            style={"color": "#666"},
        ),
        html.H2("Zone inferieure droite"),
        html.P(
        ...
        html.Ul(
            [
                ...
                html.Li("Sous la parabole et a droite de l'axe vertical tau = 0"),
            ]
        ),
        ...
        html.Ul(
            [
                ...
                html.Li(
                    "Conclusion: les deux racines sont reelles et negatives ⇒ stabilite (decroissance exponentielle)."
                ),
            ]
        ),
        ...
        html.Ul(
            [
                html.Li(
                    "Deux racines reelles negatives ⇒ combinaison de deux exponentielles decroissantes."
                ),
                html.Li(
                    "Reponse convergente sans oscillations (comportement overdamped et stable)."
                ),
            ]
        ),
        ...
        html.Ul(
            [
                html.Li("lambda1, lambda2 < 0 (dans cette zone) ⇒ decroissance"),
        ...
        html.Ul(
            [
                ...
                html.Li("Reponse = C1 e^{-1.894 t} + C2 e^{-0.106 t} (stable)"),
            ]
        ),
        html.Hr(),
        html.Div(
...
log.info("Layout de la page zone inferieure droite construit.")
